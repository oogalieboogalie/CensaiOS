...
export const OPS_WINDOW_MANIFESTS = [
  ...
  },
  {
    ...
    launcher: { show: true, startHere: true, startHereOrder: 30, order: 90, icon: 'Calendar', label: 'Schedule a run', hint: 'automate recurring work', sizeOverride: { w: 760, h: 560 } },
  },
  {
    kind: 'julesTasks',
  ...
  },
  {
    ...
    launcher: { show: true, order: 80, icon: 'Monitor', label: 'Live operations', hint: 'runtime board', sizeOverride: { w: 900, h: 620 } },
  },
  {
    kind: 'rook',
    canvasType: 'rook',
  ...
  },
  {
    ...
    launcher: { show: true, startHere: true, startHereOrder: 10, order: 14, icon: 'NewAgent', label: 'Create an agent', hint: 'configure a new specialist' },
  },
  {
    kind: 'overseer',
    canvasType: 'overseer',
    ...
    launcher: { show: true, order: 120, icon: 'Eye', label: 'Overseer Watcher', hint: 'repo auditor', sizeOverride: { w: 560, h: 460 } },
  },
  {
    kind: 'automation',
  ...
  },
  {
    ...
    moduleMenu: { show: false, status: 'internal' },
    launcher: { show: true, order: 130, icon: 'Flask', label: 'Registry Test Window', hint: 'test window' },
  },
  {
    kind: 'containers',
  ...
  },
  {
    ...
    moduleMenu: { show: false, status: 'coming-soon' },
    launcher: { show: true, order: 170, icon: 'Helm', label: 'Kubernetes', hint: 'read-only cluster view' },
  },
  {
  ...
  },
  {
    ...
    launcher: { show: true, order: 155, icon: 'ImportTray', label: 'Import Window', hint: 'drop AI Studio exports onto the canvas' },
  },
  {
    kind: 'agent_trace',
